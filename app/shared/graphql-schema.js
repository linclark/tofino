      ...
      "types": [
        {
          ...
          "fields": [
            ...
            {
              "name": "getPage",
              "description": "Get an object of type `Page` by ID.",
              "args": [
                {
                  "name": "id",
              ...
              "isDeprecated": true,
              "deprecationReason": "Use `pageById`."
            },
            {
              "name": "pageById",
              "description": "Get an object of type `Page` by `id`",
        ...
        },
        {
          ...
          "fields": [
            ...
            {
              "name": "allPages",
              "description": "A connection with all objects of type `Page`",
              "args": [
                {
                  "name": "first",
                  "description": "Number of edges to include from the beginning of the result.",
        ...
        },
        {
          "kind": "OBJECT",
          "name": "_PageConnection",
          "description": "This is a generated Connection for Page.\n\nConnection is a pattern from Relay.\nIt's a specification, designed to make management of ordered collections easier,\nwhen pagination and ordering is required. Reindex uses Connections for linking\n`Node` types and for providing an interface to retrieving all objects of some\ntype.\n\n* [Reindex docs: Connection\n](https://reindex)\n* [Relay docs: Connections\n](https://facebook.github.io/relay/docs/graphql-connections.html#content)\n",
          "fields": [
            {
              "name": "count",
              "description": "The total number of elements in the connection.\n",
            ...
            {
              "name": "nodes",
              "description": "A plain list of Page objects without the _PageEdge wrapper object.",
              "args": [],
              "type": {
                "kind": "LIST",
                "name": null,
        ...
        },
        {
          "kind": "OBJECT",
          "name": "_PageEdge",
          "description": "This is a generated Edge for Page.\n\nEdges are elements of `edges` list of Connections.\n\n* [Reindex docs: Connection\n](https://reindex)\n* [Relay docs: Connections\n](https://facebook.github.io/relay/docs/graphql-connections.html#content)\n",
          "fields": [
            {
              "name": "cursor",
              "description": "The opaque string-like object, that points to the current node. To be used with\n`before` and `after` arguments of the Connection field.\n",
        ...
        },
        {
          ...
          "fields": [
            ...
            {
              "name": "updatePage",
              "description": "Updates the given `Page` object. The given fields are merged to the existing object.",
              "args": [
                {
                  "name": "input",
                  "description": null,
            ...
            {
              "name": "replacePage",
              "description": "Replaces the given `Page` object with a new one.",
              "args": [
                {
                  "name": "input",
                  "description": null,
            ...
            {
              "name": "deletePage",
              "description": "Deletes the given `Page` object",
              "args": [
                {
                  "name": "input",
                  "description": null,
        ...
        },
        {
          "kind": "OBJECT",
          "name": "_PagePayload",
          "description": "The payload returned from mutations of `Page`.\n\n* [Reindex docs: Mutations\n](https://www.reindex.io/docs/graphql-api/mutations/)\n",
          "fields": [
            {
              "name": "clientMutationId",
              "description": "The client mutation ID used by clients like Relay to track the mutation. If given, returned in the response payload of the mutation.",
            ...
            {
              "name": "viewer",
              "description": "The global viewer object. Can be used in the client to add\na newly created object to the connection of all objects of\nthe type.\n\nE.g. when creating a Page object, you can add it\nto `viewer.allPages` using the following Relay\nmutation config:\n```javascript\n{\n  type: 'RANGE_ADD',\n  parentID: this.props.viewer.id,\n  connectionName: 'allPages',\n  edgeName: 'changedPageEdge',\n  rangeBehaviors: {\n    '': 'prepend',\n  },\n}\n```\n",
              "args": [],
              "type": {
                "kind": "OBJECT",
                "name": "ReindexViewer",
